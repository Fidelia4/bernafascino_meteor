  ...
  return (
    <footer className="w-full bg-yellow-800 text-white p-10 flex flex-col md:flex-row justify-around items-center">
      ...
      <div className="text-sm">
        <h3 className="font-bold mb-2 text-center -ml-38">Contact</h3>
      ...
      {/* Réseaux sociaux */}
      <div className="text-sm">
        <h3 className="font-bold mb-2 -ml-12 text-center">Suivez-nous</h3>
      ...
      {/* Mentions légales */}
      <div className="text-sm">
        <h3 className="font-bold mb-2 text-center -ml-12">Mentions légales</h3>
        <ul>
