...
const Footer = () => {
  return (
    <footer className="w-full bg-yellow-800 text-white p-12 flex flex-col md:flex-row justify-around items-start">
      {/* Logo */}
      <div>
        <img src="/images/logoblanc.png" alt="Fascino Logo" className="h-20 mb-4" />
      </div>
