  ...
  return (
    <section className="w-full py-16 bg-white">
      <div className="max-w-6xl mx-auto px-6 md:px-12 text-center">
        <h2 className="text-3xl font-bold mb-8 text-yellow-800">Nos Valeurs</h2>
  ...
  return (
    <section className="w-full py-16 bg-gray-50">
      <div className="max-w-6xl mx-auto px-6 md:px-12">
        <h3 className="text-2xl font-bold mb-6 text-center">Ce que nous faisons</h3>
...
function Testimonials() {
  ...
  return (
    <section className="w-full py-8 -mt-12">
      <div className="max-w-6xl mx-auto px-6 md:px-12">
        <h3 className="text-2xl font-bold mb-6 text-center">Ils parlent de nous</h3>
